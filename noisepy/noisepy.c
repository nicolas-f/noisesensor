 ...
 *         self.init = True
 */
  __pyx_t_4 = __Pyx_PyInt_NeObjC(__pyx_v_res, __pyx_int_0, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
 ...
 * 
 */
    __pyx_t_4 = __Pyx_PyString_FormatSafe(__pyx_kp_s_Init_error_d, __pyx_v_res); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 62, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
